...
function CreateTicket() {
    ...
    return (
      ...
      <div className="ticket-success-page">
        ...
        <div className="ticket-success-card">
          ...
          <p>
            Your IT support request has been
  ...
  return (
    ...
    <div className="create-ticket-content">
      ...
      <section className="create-ticket-heading">
      ...
      >
        ...
        <div className="form-section">
          ...
          <div className="form-field">
            ...
            <small>
              ...
              error messages, device names,
              or steps that caused the issue.
            </small>
        ...
        <div className="ai-notice">
          ...
          <div>
            ...
            <p>
              After submission, our AI assistant
              will analyze your issue and recommend
              a category, priority, and possible
